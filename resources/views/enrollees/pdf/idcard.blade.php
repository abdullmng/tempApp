...
<head>
    <style type="text/css">
        ...
        @media all {
            ...
            .card_front {
                background: url('{{ asset("front.jpg") }}') no-repeat;
                /*height: 5.30cm;
                width: 8.63cm;*/
                height: 5.583cm;
                width: 8.63cm;
        ...
        <div class="card_front" style="/*border:1px solid red;*/">
            ...
            <div style="float:left; width:1.6cm; padding-left:0.62cm; padding-top:0.48cm;">
                <img src="{{ $enrollee->picture }}"
                    style="width:95px; height:95px; border-radius: 10px;" />
            </div>
            ...
            <div style="margin-top: 5px;">
                <div style="float:left; width:20%; text-align: center" class="red">Date of Birth</div>
                <div style="float:left; width:20%; text-align: center" class="red">Date Issued</div>
                <div style="float:left; width:60%; text-align: center" class="red"></div>
            </div>
            <div style="clear:both;">
                <div style="float:left; width:20%; text-align: center;">{{ $enrollee->date_of_birth }}</div>
                <div style="float:left; width:20%; text-align: center;">{{ date('Y-m-d') }}</div>
                <div style="float:left; width:60%; text-align: center;"></div>
            </div>
        </div>
        <div class="card_back">
